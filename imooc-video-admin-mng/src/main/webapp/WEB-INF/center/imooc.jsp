...
.desc {
	...
	<div class="page-bar">
	    <ul class="page-breadcrumb">
	        <li>
	            <a href="<%=request.getContextPath() %>/center/center.jsp">首页</a>
	        </li>
	    </ul>
	</div>
	
	<h1 class="page-title"> 震音短视频后台管理系统 </h1>
	        ...
	        <div class="portlet light portlet-fit bordered">
	            <div class="portlet-title">
	                <div class="caption">
	                    ...
	                    <span class="caption-subject bold font-dark uppercase">短视频平台技术简介</span>
	    ...
	    <div class="col-lg-6 col-xs-12 col-sm-12">
	        <div class="portlet light portlet-fit bordered">
	            <div class="portlet-title">
	                <div class="caption">
	                    <i class="icon-microphone font-dark hide"></i>
	                    <span class="caption-subject bold font-dark uppercase">其他网站</span>
	                    <span class="caption-helper">(小作品)</span>
	                </div>
	            </div>
	            <div class="portlet-body ">
	            	<div class="row ">
	                    <div class="col-md-4 ">
	                        <img src="<%=request.getContextPath() %>/static/pages/img/course/shopping.png" width="233px" class="img-responsive"/>
	                    </div>
	                    <div class="col-md-8 " >
	                    	<h4><a href="http://www.i1314loveyou.xyz/shopping/user/index.do" target="_blank">基于SSM的简单二手购物网站</a></h4>
	                    </div>
	            ...
	            <div class="row" style="margin-top: 15px;">
	                    <div class="col-md-12">
	                        <div class="mt-widget-3" style="padding-top: 15px;">
	                        	<p class="desc">1、支付宝沙箱账号：pgxows2479@sandbox.com
	                        	</p>
								<p class="desc">2、支付宝沙箱密码：111111</p>
