...
public class VideoController {
	...
	public IMoocJSONResult bgmUpload(@RequestParam("file") MultipartFile[] files) throws Exception {
		...
		// 文件保存的命名空间
		String fileSpace = File.separator + "imooc-videos-dev" + File.separator + "mvc-bgm";
		/*String fileSpace = "D:" + File.separator + "迅雷下载" 
+ File.separator + "抖音全栈" +File.separator + "pic"+File.separator + "mvc-bgm";*/
		// 保存到数据库中的相对路径
